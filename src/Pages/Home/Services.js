        ...
        <div className='mt-28'>
            ...
            <div>
                <div className="hero min-h-screen">
                    <div className="hero-content grid md:grid-cols-1 lg:grid-cols-2 md:mt-10 sm:mt-10">
                        <img src={treatment} className="max-w-sm rounded-lg shadow-2xl mx-auto md:mb-5 sm:mb-5" />
                        <div>
